...
## Primary Authors: Susan Alexis Brown, Matthew Troemner
## ===========================================================================
...
def chronoInput(form):
    ...
    if elementType == 'IGA':
        analysis = doc.getObject("CBLanalysis")
    ...
    with open(Path(outDir + outName + '/' + geoName + '-chrono.cpp'),"w") as output_file:
        ...
        output_file.write("""
// ================================================================================
// WOOD WORKBENCH - !update github link
//
// Copyright (c) 2024 
// All rights reserved. 
//
...
// ================================================================================
// 
// Wood Workbench developed by Cusatis Computational Services, Inc.
//
// ================================================================================
        \n""")
...
int main(int argc, char** argv) {
        ...
        output_file.write('    std::stream nodesFilename = "' + '-mesh.txt' + '";\n')
        output_file.write('    std::stream elemFilename = "' + '-ridge.mesh' + '";\n')
        output_file.write('    std::stream facetsFilename = "' + '-vertex.mesh' + '";\n')
